...
export const DEFAULT_HANDLER_LATENCY_MS = 20; // for all handler types
...
export const DEFAULT_PRODUCER_CONCURRENCY = 200;
export const DEFAULT_PRODUCER_RATE = 2; // continuous producer: instances/s (CONTINUOUS_BATCH / CONTINUOUS_INTERVAL_S)
